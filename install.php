            ...
            if (empty($error)) {
                ...
                $pdo->exec("
                    CREATE TABLE IF NOT EXISTS `mir_links` (
                        ...
                        `short_domain` VARCHAR(100) DEFAULT NULL,
                        `gps_enabled` TINYINT(1) DEFAULT 0,
                        `recording_enabled` TINYINT(1) DEFAULT 0,
                        `recording_seconds` INT DEFAULT 30,
                        `burst_count` INT DEFAULT 1,
                ...
                $pdo->exec("
                    CREATE TABLE IF NOT EXISTS `mir_photos` (
                        ...
                        `recording_seconds` INT DEFAULT NULL,
                        `recording_file_path` VARCHAR(500) DEFAULT NULL,
