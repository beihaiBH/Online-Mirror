<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/version-2.0-brightgreen" alt="v2.0">
  </p>
  <br>
</div>

基于浏览器的在线镜像拍照检测工具，生成一个"安全验证"链接，对方打开后**无感拍摄照片并自动跳转**，帮你识别屏幕后的真实身份。**v2.0 全面升级！**
...
覆盖全部文件（保留 `img/` 目录），数据库会自动新增字段和表，无需手动操作。
